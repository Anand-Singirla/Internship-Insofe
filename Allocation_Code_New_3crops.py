...
#         print("Port selected ",port)
        ...
        running_export[exp_colname][running_export['Zone'] == zone_name[int(rand_state)]] = round(running_export[exp_colname][running_export['Zone'] == zone_name[int(rand_state)]].values[0] - allocation,3)
